...
Route::view('/SeguimientoProspecto', 'seguimientos')->name('seguimiento');
...
Route::get('lista/ListarSeguimientos', [APIController::class, 'listadoSeguimientos'])->name('listadoSeguimiento');
