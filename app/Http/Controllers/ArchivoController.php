...
class ArchivoController extends Controller
{
    ...
    public function validarArchivo(Request $request)
    {
        ...
        try {
            ...
            $request = new \GuzzleHttp\Psr7\Request('PUT', 'https://webapiportalplanillamuya.azurewebsites.net/api/Masivo/ObtenerValidaVacaciones/12345678911', $headers, $contenidoJson);
    ...
    public function subirArchivo(Request $request)
    {
        ...
        try {
            ...
            $request = new \GuzzleHttp\Psr7\Request('PUT', 'https://webapiportalplanillamuya.azurewebsites.net/api/Masivo/InsertarSolicitudVacacionesMasivo/12345678911', $headers, $contenidoJson);
            $promise = $client->sendAsync($request)->then(function ($response) {
                echo  $response->getBody();
                $code = $response->getStatusCode();
                $reason = $response->getReasonPhrase();
    ...
    public function subirArchivoConfiguraciones(Request $request)
    {
        ...
        try {
            ...
            $request = new \GuzzleHttp\Psr7\Request('PUT', 'https://webapiportalplanillamuya.azurewebsites.net/api/Masivo/InsertarConfiguracionMasivo/12345678911', $headers, $contenidoJson);
            $promise = $client->sendAsync($request)->then(function ($response) {
                echo  $response->getBody();
                $code = $response->getStatusCode();
                $reason = $response->getReasonPhrase();
