                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-1 mb-3">
                                    <label for="annoIni" class="col-form-label">Inicio:</label>
                                </div>
                                ...
                                <div class="col-md-1 mb-3">
                                    <label for="annoFin" class="col-form-label">Fin:</label>
                                </div>
                                <div class="col-md-2 mb-3">
                                ...
                                <div class="col-md-2 mb-3 d-flex align-items-end">
                                    <button class="btn btn-success btnDorado login-btn" style="margin-top: 0%"
                                        id="buscarDoc">Buscar
                                        <i class="bi bi-search"></i><span></span></button>
                                </div>
                            </div>
                ...
                for (var year = startDate; year <= parseInt(endDateSelect.value); year++) {
                    ...
                    <section class="section dashboard" id="resultado_${year}">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <div class="card">
                                    <h5 class="card-header" style="font-size: 2em; color: #468EC3 !important;">${year}</h5>
