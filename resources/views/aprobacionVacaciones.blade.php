    ...
    <main id="main" class="main">
            ...
            <div class="row">
                <div class="col-md-12 d-md-block">
                    ...
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Lista de Trabajadores
                        </h4>
                    </div>
                    <div class="card_vacaciones">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="card-title" style="font-size: 18px; display:none">Lista de trabajadores
                                    </h5>
                                </div>
                                ...
                                <div class="col-md-12 table-responsive" style="padding-left: 2rem;padding-right: 2rem;">
                                    <div class="row">
                                        <div class="col-md-12 table-responsive"
                                            style="padding-left: 2rem;padding-right: 2rem;height: fit-content">
                                            <table class="table table-striped " id="listaColab"
                ...
                <div class="col-md-12 d-md-block">
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="card-title" style="font-size: 18px; display:none">Solicitudes por aprobar
                                    </h5>
                                </div>
                                <div class="col-md-2 offset-md-4 mb-4 mt-3 btnListaVacaciones">
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responsive" style="padding-left: 2rem;padding-right: 2rem;">
                                    <div class="row">
                                        <div class="col-md-12 table-responsive"
                                            style="padding-left: 0rem;padding-right: 1rem;height: 400px">
                                            <table class="table table-striped" id="tablaSolAprobar"
                                                style="text-align: center; height: 300px;">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" width="15%">Trabajador</th>
                                                        <th scope="col" width="10%">Inicio</th>
                                                        <th scope="col" width="10%">Fin</th>
                                                        <th scope="col" width="5%">Días</th>
                                                        <th scope="col" width="10%">Reincorporación</th>
                                    ...
                                    <br>
                                    <div class="row">
                                        <div class="offset-md-8 col-12 col-md-4 d-flex align-items-center">
                                            <input class="form-check-input chkDatos" type="checkbox"
                                                id="CheckVerEquipEquip">
                                            <h5 class="mb-0 ms-2" style="font-size: 17px; white-space: nowrap;">
                                                Visualizar equipos de mi equipo</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-12 d-md-block">
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 28px;" hidden></h5>
                            <div class="row">
                                <div class="col-md-4" style="margin-bottom: 1rem;">
                                    <h1 class="card-title tarjeta-vaca-foco"><b><span id="indPromVac"></span></b></h1>
                                    <h5 style="font-size: 17px; text-align: center;">Promedio de días
                                        pendientes de vacaciones del equipo <b>hasta fin de año</b></h5>


                                    <div class="card" hidden>
                                        <div class="card-body">
                                            <h1 class="card-title tarjeta-vaca-foco"><b><span
                                                        id="indPromVac"></span></b></h1>
                                            <h5 style="font-size: 17px; text-align: center;">Promedio de días
                                                pendientes de vacaciones del equipo <b>hasta fin de año</b></h5>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4" style="margin-bottom: 1rem;">
                                    <h1 class="card-title tarjeta-vaca-foco"><b><span id="indPromVacPend"></span></b>
                                    </h1>
                                    <h5 style="font-size: 17px;text-align: center;">Promedio de días pendientes
                                        de vacaciones del equipo <b>a la fecha de hoy</b></h5>

                                    <div class="card" hidden>
                                        <div class="card-body">
                                            <h1 class="card-title tarjeta-vaca-foco"><b><span
                                                        id="indPromVacPend"></span></b></h1>
                                            <h5 style="font-size: 17px;text-align: center;">Promedio de días pendientes
                                                de vacaciones del equipo <b>a la fecha de hoy</b></h5>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4" style="margin-bottom: 1rem;">
                                    ...
                                    <h5 style="font-size: 17px;text-align: center;">Número de reprogramaciones
                                        realizadas en el año del equipo</h5>
                                    <div class="card" hidden>
                                        <div class="card-body">
                                            <h1 class="card-title tarjeta-vaca-foco"><b><span
                                                        id="indRepVac"></span></b></h1>
                                            <h5 style="font-size: 17px;text-align: center;">Número de reprogramaciones
                                                realizadas en el año del equipo</h5>
                                        </div>
                                    </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-12">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Reporte de vacaciones por trabajador</h4>
                    </div>
                    <div class="card_vacaciones">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2 mt-4 text-center">
                                    <div class="form-group">
                                        <button class="btn btn-success btnDorado" id="buscarDoc">Descargar</button>
                                    </div>
                                </div>
                                <div class="col-2 col-md-1 mt-4 text-center">
                                    <input class="form-check-input chkDatos" checked type="checkbox"
                                        id="checkVisualizarVacaciones">
                                </div>
                                <div class="col-10 col-md-3 mt-4 text-left">
                                    <div class="form-group">
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-12">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Reporte de solicitud de vacaciones</h4>
                    </div>
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 col-sm-4 col-md-2 mt-4">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-sm-6 col-md-2 mt-4 text-center">
                                    <div class="form-group">
                                        <button class="btn btn-success btnDorado"
                                            id="btnDescargSolVac">Descargar</button>
                                    </div>
                                </div>
                                <div class="col-2 col-sm-1 col-md-1 mt-4 text-center">
                                    <input class="form-check-input chkDatos" checked type="checkbox" value=""
                                        id="CheckDescSolVac">
                                </div>
                                <div class="col-10 col-sm-5 col-md-3 mt-4 text-left">
                                    <div class="form-group">
                                        <h5>Visualizar equipos de mi equipo</h5>
                                    </div>
                                </div>
                ...
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-2 offset-md-5 mt-4" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado" data-bs-toggle="modal"
                                                data-bs-target="#ModalReglas" id="buscarDoc">Ver reglas</button></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    window.onload = function() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'codTrabajador': '@php echo(session('codTrabajador')) @endphp'
            },
            success: function(result) {
                ...
                result['response'].forEach(element => {
                    ...
                    var filaData = [
                        ...
                        element['flg_no_cruzar_jefe_oculto'] + '" id="flexCheckDefault">',
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                var aux = (respuesta['response'] == '') ? 'No hay reglas definidas por el momento..' :
                    respuesta['response'][0]['dsc_regla'];
                body.innerHTML = aux;
            }, //success
            error(e) {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                respuesta['response'].forEach(function(word) {
                    //console.log(word);
                    $("#annoIniVE").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
                    $("#annoFinVE").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                result['response'].forEach(element => {
                    ...
                    if (element['dsc_estado'] == 'APROBADO' || element['dsc_estado'] ==
                        'RECHAZADO') {
                        disabled = 'disabled';
                        equipo = 'SI';
                    } else {
                    ...
                    var filaData = [
                        ...
                        alertaRegla,
                        alertaReprog,
                        '<input class="form-check-input checkVerde" ' + disabled +
                        ' type="checkbox" name="radioBtnSol' + element['cod_trabajador'] + '-' +
                        element['num_linea'] + '" id="aprobSol" value="APROBAR-' + element[
                            'cod_trabajador'] + '-' + element['num_linea'] + '-' + fchIni +
                        '-' + fchFin + '">',
                        '<input class="form-check-input checkRojo" type="checkbox" ' +
                        disabled +
                        ' name="radioBtnSol' + element['cod_trabajador'] + '-' + element[
                            'num_linea'] + '" id="recSol" value="RECHAZAR-' + element[
                            'cod_trabajador'] + '-' + element['num_linea'] + '-' + fchIni +
                        '-' + fchFin + '">',
                        element['flg_equipo']
                    ];
                ...
                var tbody = $('#tablaSolAprobar tbody');
                ...
                tbody.on('change', '.checkVerde, .checkRojo', function() {
                    var checkbox = $(this);
    ...
    //                     fchRechz = (element['fch_rechazado'] == '01/01/1990') ? '' :
    //                         fchRechz;
    ...
    function enviaAprobacionVac(codTra, fchIni, fchFin, numSolicitud) {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                var actividad = 'La solicitud de vacaciones ha sido aprobada. (Inicio: ' + fchIni +
                    ', fin: ' + fchFin + ')';
    ...
    function enviaRechazoVacJefe(codTra, fchIni, fchFin, numSolicitud) {
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                var fechaFormateada = diaFormateado + '/' + mesFormateado + '/' + anio;
                var fchBD = anio + '-' + mesFormateado + '-' + diaFormateado;
                var actividad = 'La solicitud de vacaciones ha sido rechazada. (Inicio: ' + fchIni +
                    ', fin: ' + fchFin + ')';
                var solicitante = "'" + '@php echo(session('nombreTrabajador')) @endphp' + "'";
    ...
    btnProcesarD.addEventListener("click", function() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                if (respuesta['response'].length > 0) {
                    var header = ['CODIGO TRABAJADOR', 'NOMBRES Y APELLIDOS', 'LOCALIDAD', 'CARGO',
                        'AREA', 'FECHA INGRESO', 'VACACIONES GENERADAS',
                        'VACACIONES SOLICITADAS', 'SALDO', 'ESTADO ADELANTO VACACIONES',
                        'GRUPO', 'TIPO COMISIONISTA', 'REQUIERE APROBACION', 'APROBADOR',
                        ' REQUIERE SUPERVISION', 'SUPERVISOR', 'REGLA'
                    ];
                    var filasArray = [];
    ...
    //             });
    //         } else {
    //             if (data.response.dsc_observacion && data.response.dsc_observacion != "OK") {
    //                 Swal.fire({
    //                     icon: 'error',
    //                     title: 'Error',
    //                     html: data.mensaje,
    ...
    //                                 //envia correo a trabajador
    //                                 var promesa = enviaCorreoMensaje(codTra,
    //                                     codTraSolic,
    //                                     dscSolicitante, codMensaje, '', asunto,
    ...
    //                                     fchInicio + ', fin: ' + fchFin + ')';
    //                                 //envia correo a trabajador
    //                                 enviaCorreoMensaje(codTra, codTraSolic,
    //                                     dscSolicitante, codMensajeA, '',
    //                                     asuntoA, actividadA, numSolicitud);
    ...
    //                         var promesa = enviaCorreoMensaje(codTraSolic, codTraSolic,
    //                             dscSolicitante,
    //                             '4005', '',
