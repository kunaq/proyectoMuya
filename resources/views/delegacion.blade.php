                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <p class="titulo-tarjetaConfig" style="color: #468EC3;"><b><i
                                                class="fa-solid fa-magnifying-glass"></i> Delegacion</b></p>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div id="message">
                                        <p style="text-align: justify;">Delegación de permisos de aprobación de
                                            vacaciones por vacaciones y/o licencia</p>
                                    </div>
                                </div>
                                <br> <br>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div id="message">
                                            <p class="titulo-tarjetaConfig" style="color: #468EC3;"><b>Elegir al
                                                    delegado:</b>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4 offset-md-4" style="text-align: -webkit-center;">
                                            <button class="btn_accept_vac" id="" type="submit"
                                                onclick="ActualizarDelegado()">Aceptar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
