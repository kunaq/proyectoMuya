        ...
        <section class="section dashboard">
            <div class="row col-md-6 offset-4">
                ...
                <div class="col-5 col-md-3" style="text-align: -webkit-center">
                    <div class="form-group">
                        <h5><button class="btn btn-success btnDorado" id="buscarFimp"
                                onClick="BuscarPagos();">Buscar&nbsp;&nbsp;<span class="bi bi-search"></span></button>
                        </h5>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped tableDatos">
                                    <tbody style="text-align: center;">
                                        <tr class="tr_bg_fechas">
                                            <th class="th_bg_datos"
                                                style="border-top-left-radius: 15px; border-bottom-left-radius: 15px;"
                                                scope="col">
                                                Enero</th>
                                            <th class="th_bg_datos" scope="col">Febrero</th>
                                            <th class="th_bg_datos" scope="col">Marzo</th>
                                            <th class="th_bg_datos" scope="col">Abril</th>
                                            <th class="th_bg_datos" scope="col">Mayo</th>
                                            <th class="th_bg_datos"
                                        ...
                                        <tr class="tr_bg_fechas">
                                            <th class="th_bg_datos"
                                                ...
                                                scope="col">
                                                Julio</th>
                                            <th class="th_bg_datos" scope="col">Agosto</th>
                                            <th class="th_bg_datos" scope="col">Septiembre</th>
                                            <th class="th_bg_datos" scope="col">Octubre</th>
                                            <th class="th_bg_datos" scope="col">Noviembre</th>
                                            <th class="th_bg_datos"
                                                style="border-top-right-radius: 15px; border-bottom-right-radius: 15px;"
                                                scope="col">Diciembre</th>
                                        </tr>
                                        <tr>
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <div class="card">
                        <div class="card-body d-none d-md-block">
                            <h5 class="card-title" style="font-size: 20px; text-align: center;">PAGO DE ADELANTO DE
                                VACACIONES</h5>
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped tableDatos" style="text-align: center;">
                                    <tbody>
                                        ...
                                        <tr class="tr_bg_fechas">
                                            ...
                                            <th class="th_bg_datos" scope="col">Mayo</th>
                                            <th class="th_bg_datos"
                                                style="border-top-right-radius: 15px; border-bottom-right-radius: 15px;"scope="col">
                                                Junio</th>
                                        </tr>
                                        <tr>
                        ...
                        <div class="row card-body">
                            <div class="col-md-10 offset-md-1" style="border-bottom: 0px;margin-bottom: -1rem;">
                                ...
                                <table class="table table-striped tableDatos">
                                    <tbody style="text-align: center;">
                                        <tr class="tr_bg_cts">
                                            <th class="th_bg_cts" scope="col"
                                                style="border-top-left-radius: 15px; border-bottom-left-radius: 15px;">
                                                Mayo</th>
                                            <th style="border-top-right-radius: 15px; border-bottom-right-radius: 15px;"
                                                class="th_bg_cts" scope="col">Noviembre</th>
                                        </tr>
                                        <tr>
                    ...
                    <div class="card">
                        <div class="row card-body">
                            <div class="col-md-10 offset-md-1" style="border-bottom: 0px;margin-bottom: -1rem;">
                                ...
                                <table class="table table-striped tableDatos">
                                    <tbody style="text-align: center;">
                                        <tr class="tr_bg_grati">
                                            <th class="th_bg_grati" scope="col"
                                                style="border-top-left-radius: 15px; border-bottom-left-radius: 15px;">
                                                Julio</th>
                                            <th class="th_bg_grati" scope="col"
                                                style="border-top-right-radius: 15px; border-bottom-right-radius: 15px;">
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                respuesta['response'].forEach(function(word) {
                    ...
                    $("#annoFimp").append('<option value="' + word['codvar'] + '" ' +
                        seleccion + '>' + word['desvar1'] + '</option>');
                });
            }, //success
            error(e) {
