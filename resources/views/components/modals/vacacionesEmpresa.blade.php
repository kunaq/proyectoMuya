                ...
                <div class="modal-content">
                  ...
                  <input  class="btn btn-success btnDorado" type="file" name="archivo">
                        ...
                        <div class="row" style="display: flex; align-items: baseline;">
                            <div class="col-12 col-md-12 mb-3">
                                <p class="form-label" style="margin-left:5%">Seleccione un archivo Excel con <i
                                        id="ayudaCargaMasivaEmp"> <u>formato válido</u></i> y extensión .xls/.xlsx</p>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success btnDorado" data-bs-dismiss="modal" type="submit" id="buscarDoc2"
    ...
    <div class="modal fade" id="ModalReglas" tabindex="-1" aria-labelledby="ModalReglasLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title tarjeta-vaca-foco fs-5" id="ModalReglasLabel">Reglas de Solicitud de
                        vacaciones</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <nav>
                    <div class="nav nav-pills nav-fill navDatPer" id="nav-tab" role="tablist">
                        <button class="nav-item nav-item-left nav-link active" id="navSupervisor-tab"
                            data-bs-toggle="tab" data-bs-target="#navSupervisor" type="button" role="tab"
                            aria-controls="navSupervisor" aria-selected="true">Responsable</button>
                        <button class="nav-item nav-item-right nav-link" id="nav-colaborador-tab"
                            data-bs-toggle="tab" data-bs-target="#nav-colaborador" type="button" role="tab"
                            aria-controls="nav-colaborador" aria-selected="false">Colaborador</button>
                    </div>
                </nav>
                <div class="modal-body">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade" id="nav-colaborador" style="margin-bottom: 2rem;" role="tabpanel"
                            aria-labelledby= "nav-colaborador-tab"></div>

                        <div class="tab-pane fade show active" id="navSupervisor" style="margin-bottom: 2rem;"
                            role="tabpanel" aria-labelledby="navSupervisor-tab"></div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="ModalModifReglas" tabindex="-1" aria-labelledby="ModalModifReglasLabel"
        aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title tarjeta-vaca-foco fs-5" id="ModalReglasLabel">Modificar reglas de Solicitud
                        de vacaciones</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <nav>
                    <div class="nav nav-pills nav-fill navDatPer" id="nav-tab" role="tablist">
                        <button class="nav-item nav-item-left nav-link active" id="navModfSupervisor-tab"
                            data-bs-toggle="tab" data-bs-target="#navModfSupervisor" type="button" role="tab"
                            aria-controls="navModfSupervisor" aria-selected="true">Responsable</button>
                        <button class="nav-item nav-item-right nav-link" id="navModifcolaborador-tab"
                            data-bs-toggle="tab" data-bs-target="#navModifcolaborador" type="button" role="tab"
                            aria-controls="navModifcolaborador" aria-selected="false">Colaborador</button>
                    </div>
                </nav>
                <div class="modal-body">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade" id="navModifcolaborador" style="margin-bottom: 2rem;"
                            role="tabpanel" aria-labelledby= "navModifcolaborador-tab">
                            <textarea class="form-control" id="txtReglasColab" rows="15">         
                   </textarea>
                        </div>

                        <div class="tab-pane fade show active" id="navModfSupervisor" style="margin-bottom: 2rem;"
                            role="tabpanel" aria-labelledby="navModfSupervisor-tab">
    ...
    <div class="modal fade" id="ModalParametros" tabindex="-1" aria-labelledby="ModalReglasLabel"
        aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="tab-pane fade show active" id="navSupervisor" style="margin-bottom: 2rem;" role="tabpanel" aria-labelledby="navSupervisor-tab"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <input type="number" class="form-control" name="parametroX" id="parametroX"
                                    aria-describedby="helpId" min="0" max="99">
                            </div>
                            <div class="col-12 col-md-2 offset-md-1">
                                <label for="parametroY" class="form-label">Parámetro Y:</label>
                            </div>
                            <div class="col-12 col-md-3">
                                <input type="number" class="form-control" name="parametroY" id="parametroY"
                                    aria-describedby="helpId" min="0" max="99">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <small id="helpId" class="form-text text-muted">Cantidad máxima de trabajadores de
                                    un mismo grupo que pueden coincidir en sus vacaciones en un mismo día. </small>
                            </div>
                            <div class="col-12 col-md-6">
                                <small id="helpId" class="form-text text-muted">Cantidad total de días que pueden
                                    exeder las vacaciones solicitadas</small>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success btnDorado"
