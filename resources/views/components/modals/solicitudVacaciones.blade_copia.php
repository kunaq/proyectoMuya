                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p id=resutSolVac3></p>
                                    <input type="hidden" id="codEstado">
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    result['response'].forEach(element => {
                        ...
                        var codEstado = element['dsc_estado'];
                        ...
                        var filaData = [
                            ...
                            flgFirmado,
                            flgPagado,
                            '<button class="btn btn-success btnDorado" data-bs-toggle="tooltip" data-bs-placement="top" ' +
                            ...
                            '<button class = "btn btn-success verdeMuya" data-bs-toggle="tooltip" data-bs-placement="top" title = "Descargar" ' +
                            disBtnDwn + '><span class="bi bi-download" onClick="descargaDoc(' +
                            cantDias + ',' + numLinea + ')"></span></button>' +
                            '<button class = "btn btn-secondary" data-bs-toggle="modal" data-bs-target="#ModalSolicitud" data-bs-toggle = "tooltip" data-bs-placement="top" title = "Modificar" ' +
                        ...
                        var filaDataMovil = [
                            ...
                            '<button class="btn btn-success btnDorado" ' + disBtnFir +
                            ' ontouchstart ="enviaDocSoli(' + codTrabajador + ',' + finFchIni +
                            ',' + finFchFin + ',' + fchReinc + ',' + cantDias + ',' + numLinea +
                            ',this)">Firma</button>' +
                            '<button class="btn btn-success verdeMuya"  ' + disBtnDwn +
                            ' ontouchstart="descargaDoc(' + cantDias + ',' + numLinea +
                            ')">Descarga</button>' +
                            '<button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#ModalSolicitud" ' +
                            disBtnEdit + ' ontouchstart ="reprograma(' + cantDias + ',' + numLinea +
                            ',' + finFchIni + ',' + finFchFin + ',' + fchReinc + ',' +
                            codEstado ')">Edita</button>' +
                            '</div>' +
                            '</td>' +
                            '</tr>'
                        ];
