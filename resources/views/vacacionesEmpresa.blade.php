    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard d-sm-block d-md-none">
            <div class="row">
                <div class="col-md-10 offset-md-1 d-md-block">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="tarjeta-vaca-foco" style="font-size: 18px; padding-top: 1rem;;">Para acceder a
                                todas las opciones por favor ingresar desde su ordenador.</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12  d-md-block">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Lista de trabajadores a nivel
                            nacional
                        </h4>
                    </div>
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="card-title" style="font-size: 18px;" hidden>Lista de trabajadores a nivel
                                        nacional</h5>
                                </div>
                                <div class="col-md-2 offset-md-4 mb-4 mt-3 btnListaVacaciones">
                                    <button class="btn btn-success btnDorado"
                                        id="actualizaConfigEmp">Actualizar</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 table-responsive" style="padding-right: 2rem;height: 23rem;">
                                    <table class="table table-striped align-middle text-center" data-page-length="20"
                                        id="listaColabEmp" style="text-align: center; height: 300px;">
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-12 d-md-block">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Solicitudes por aprobar
                        </h4>
                    </div>
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="card-title" style="font-size: 18px;" hidden>Solicitudes por aprobar</h5>
                                </div>
                                <div class="col-md-2 offset-md-4 mb-4 mt-3 btnListaVacaciones">
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responsive"
                                    style="padding-left: 1rem;padding-right: 1rem;height: 23rem;">
                                    <table class="table table-striped " data-page-length="20" id="tablaSolAprobarEmp"
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-12 d-md-block">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Indicadores de Gestión
                        </h4>
                    </div>
                    <div class="card_vacaciones">
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 28px;" hidden>Indicadores de gestión</h5>
                            ...
                            <div class="row" style="justify-content: center;gap: 5%;text-align: center;">
                                        ...
                                        <div class="card-body">
                                            <h5 style="font-size: 17px; text-align: center; padding-top: 1rem;">
                                                Promedio de días pendientes de vacaciones del equipo <b>hasta fin de
                                                    año</b></h5>
                                            <hr>
                                            <h1 class="tarjeta-vaca-foco"><b><span id="indPromVacPend"></span></b>
                                            </h1>
                                            <hr>
                                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 style="font-size: 17px;text-align: center; padding-top: 1rem;">Promedio
                                                de días pendientes de vacaciones del equipo <b>a la fecha de hoy</b>
                                            </h5>
                                            <hr>
                                            <h1 class="tarjeta-vaca-foco"><b><span id="indPromVacPendHoy"></span></b>
                                            </h1>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-12" style="margin-bottom: 1rem;">
                                                    <div class="form-group">
                                                        <select name="sedePromVacPendHoy" id="sedePromVacPendHoy"
                                                            class="form-control selectForm">
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <select name="areaPromVacPendHoy" id="areaPromVacPendHoy"
                                                            class="form-control selectForm">
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-4 mt-4" hidden>
                                    <div class="card">
                                        <div class="card-body">
                                            <h5
                                                style="font-size: 17px;text-align: center; padding-top: 1rem;padding-bottom:1rem;">
                                                Número de reprogramaciones realizadas en el año del equipo</h5>
                                            <hr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="margin-bottom: 1rem;">
                                                    <div class="form-group">
                                                        <select name="sedeReprog" id="sedeReprog"
                                                            class="form-control selectForm">
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <select name="areaReprog" id="areaReprog"
                                                            class="form-control selectForm">
                                                        </select>
                                                    </div>
                                                </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-12 d-md-block">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Reporte de solicitud de vacaciones
                        </h4>
                    </div>

                    <div class="card_vacaciones">
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 28px;" hidden>Descargar solicitudes de vacaciones
                            </h5>
                            <div class="row">
                                <div class="col-3 offset-md-2 col-md-1 mt-4" style="margin-bottom: 1rem;">
                                    <div class="form-group">
                                        <span>Inicio:</span>
                                    </div>
                                </div>
                                <div class="col-9 col-md-2 mt-4" style="margin-bottom: 1rem;">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="datepicker3"
                                            placeholder="Seleccione..">
                                    </div>
                                </div>
                                <div class="col-3 col-md-1 mt-4" style="margin-bottom: 1rem;">
                                    <div class="form-group">
                                        <span>Fin:</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 mt-4" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado"
                                                id="btnDesSolEmp">Descargar</button></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-12 d-md-block">
                    ...
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Cargar vacaciones
                        </h4>
                    </div>
                    ...
                    <div class="card_vacaciones">
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 28px;" hidden>Cargar vacaciones</h5>
                            <div class="row" style="text-align: center">
                                <div class="col-12 mt-3">
                                    <button class="btn btn-success btnDorado" data-bs-toggle="modal"
                                        data-bs-target="#ModalCargaMasiva" id="buscarDoc">Carga Masiva</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-12 d-md-block">
                    <div class="tittle_card">
                        <h4 class="titulo_registro_v">Reglas de solicitud de vacaciones
                        </h4>
                    </div>

                    <div class="card_vacaciones">
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 28px;" hidden>Reglas de solicitud de vacaciones
                            </h5>
                            <div class="row">
                                <div class="col-md-2 offset-md-2 mt-4" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado" data-bs-toggle="modal"
                                                data-bs-target="#ModalReglas"
                                                style="width: -webkit-fill-available;">Ver reglas</button></h5>
                                    </div>
                                </div>
                                <div class="col-md-2 offset-md-1 mt-4" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado" data-bs-toggle="modal"
                                                data-bs-target="#ModalModifReglas"
                                                style="width: -webkit-fill-available;">Modificar reglas</button></h5>
                                    </div>
                                </div>
                                <div class="col-md-2 offset-md-1 mt-4" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado" data-bs-toggle="modal"
                                                ...
                                                style="width: -webkit-fill-available;">Parámetros</button></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    window.onload = function() {
            ...
            success: function(result) {
                ...
                result['response'].forEach(element => {
                    ...
                    if (element['flg_solicitud_firmado'] == 'SI') {
                        alertaRegla =
                            '<a href="#" style="font-size: 28px;color:red;" title="Falta firma de solicitud de vacaciones"><span class="bi bi-exclamation-triangle"></span></a>';
                    } else {
                        alertaRegla = '';
                    }
                    ...
                    var filaData = [
                        ...
                        '<input class="form-check-input checkDorado" type="checkbox" ' +
                        flgJefe + ' value="JEFE-' + element['cod_trabajador'] + '-' +
                        element['cod_grupo_vacaciones'] + '-' + element['num_linea'] +
                        '" id="flexCheckDefault">',
                        '<input class="form-check-input checkVerde" type="checkbox" ' +
                        flgEntre + ' value="ENTRE-' + element['cod_trabajador'] + '-' +
                        element['cod_grupo_vacaciones'] + '-' + element['num_linea'] +
            ...
            success: function(result) {
                ...
                result['response'].forEach(element => {
                    ...
                    if (element['flg_alerta_regla'] == 'NO' || element['flg_alerta_regla'] ==
                        ...
                        tipo = "'reglas'";
                        alertaRegla =
                            '<span class="bi bi-exclamation-triangle" onclick="muestraInfo(' +
                            codTra + ',' + dscTra + ',' + tipo + ',' + regla1 + ',' + regla2 +
                            ')" style="font-size: 28px;color:red;"></span>';
                    }
                    ...
                    if (element['flg_reprogramar'] == 'NO' || element['flg_reprogramar'] ==
                        ...
                        alertaReprog =
                            '<span class="bi bi-exclamation-triangle" onclick="muestraInfo(' +
                            codTra + ',' + dscTra + ',' + tipo + ',' + element['num_linea'] +
                            ',' + element['num_linea_origen'] +
                            ');" style="font-size: 28px;color:red;"></span>';
                    }

                    if (element['flg_aprobado'] == 'SI' && element['flg_rechazado'] == 'NO') {
                        deshabilitaRechazo = 'disabled';
                        deshabilitaAprueba = 'disabled';

                    } else if (element['flg_rechazado'] == 'SI' || element['flg_pagado'] ==
                        'SI') {
                        deshabilitaRechazo = 'disabled';
                        deshabilitaAprueba = 'disabled';
                        deshabilitaAnulado = 'disabled';
                    }
                    ...
                    var filaData = [
                        ...
                        alertaRegla,
                        alertaReprog,
                        '<input class="form-check-input checkVerde" type="checkbox" name="radioBtnSol' +
                        element['cod_trabajador'] + '-' + element['num_linea'] + '" ' +
                        deshabilitaAprueba + ' id="aprobSol" value="APROBAR-' + element[
                            'cod_trabajador'] + '-' + element['num_linea'] + '-' + fchIni +
                        '-' + fchFin + '">',
                        '<input class="form-check-input checkRojo" type="checkbox" name="radioBtnSol' +
                        element['cod_trabajador'] + '-' + element['num_linea'] +
                        '" id="recSol"  ' + deshabilitaRechazo + ' value="RECHAZAR-' +
                        element['cod_trabajador'] + '-' + element['num_linea'] + '-' +
                        fchIni + '-' + fchFin + '">',
                        '<input class="form-check-input checkDorado" type="checkbox" name="radioBtnSol' +
                        element['cod_trabajador'] + '-' + element['num_linea'] +
                        '" id="anularSol" ' + deshabilitaAnulado + ' value="ANULAR-' +
                        element['cod_trabajador'] + '-' + element['num_linea'] + '-' +
                        fchIni + '-' + fchFin + '">',
                    ];
                    filasArray.push(filaData);
                });
                var tbody = $('#tablaSolAprobarEmp tbody');
                ...
                // Asignar evento de cambio a los checkboxes utilizando un delegado
                tbody.on('change', '.checkVerde, .checkRojo, .checkDorado', function() {
                    var checkbox = $(this);
                    var row = checkbox.closest('tr');

                    if (checkbox.hasClass('checkVerde')) {
                        row.find('.checkRojo').prop('checked', false);
                        row.find('.checkDorado').prop('checked', false);
                    } else if (checkbox.hasClass('checkRojo')) {
                        row.find('.checkVerde').prop('checked', false);
                        row.find('.checkDorado').prop('checked', false);
                    } else if (checkbox.hasClass('checkDorado')) {
                        row.find('.checkVerde').prop('checked', false);
                        row.find('.checkRojo').prop('checked', false);
                    }
                });
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                var aux = (respuesta['response'] == '' || (respuesta['response'][0]['dsc_regla'] ==
                    '')) ? 'No hay reglas definidas por el momento..' : respuesta['response'][0][
                    'dsc_regla'
                ];
                body.innerHTML = aux;
                body2.innerHTML = aux;
        ...
        var promesa1 = $.ajax({
            ...
            success: function(respuesta) {
                ...
                respuesta['response'].forEach(function(word) {
                    ...
                    $("#sedePromVacPend").append('<option value="' + word['cod_localidad'] +
                        '">' + word['dsc_localidad'] + '</option>');
                    $("#sedePromVacPendHoy").append('<option value="' + word['cod_localidad'] +
                        '">' + word['dsc_localidad'] + '</option>');
                    $("#sedeReprog").append('<option value="' + word['cod_localidad'] + '">' +
                        word['dsc_localidad'] + '</option>');
                });
            }, //success
            error(e) {
        ...
        var promesa2 = $.ajax({
            ...
            success: function(respuesta) {
                ...
                respuesta['response'].forEach(function(word) {
                    $("#areaPromVacPend").append('<option value="' + word['cod_area'] + '">' +
                        word['dsc_area'] + '</option>');
                    $("#areaPromVacPendHoy").append('<option value="' + word['cod_area'] +
                        '">' + word['dsc_area'] + '</option>');
                    $("#areaReprog").append('<option value="' + word['cod_area'] + '">' + word[
                        'dsc_area'] + '</option>');
                });
            }, //success
            error(e) {
    ...
    btnProcesar.addEventListener("click", function() {
        ...
        for (var i = 0; i < filas.length; i++) {
            var fila = filas[i];
            var inputsRadio = fila.querySelectorAll('input[type="checkbox"]:checked');
    ...
    function procesarSolicitud(accion, codTrabajadorLista, numLineaLista, fchIni, fchFin) {
        ...
        if (accion == 'RECHAZAR') {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    'codTra': codTrabajadorLista,
                    'numLinea': numLineaLista
                },
                success: function(respuesta) {
                    //console.log(respuesta,' ObtenerValidacionVacacionesPagadas');
                    if (respuesta == 'NO') {
                        $.ajax({
                            url: 'api/RechazarSolicitudVacaciones',
                            method: "PUT",
                            ...
                            success: function(respuesta) {
                                enviaRechazoVac(codTrabajadorLista, fchIni, fchFin, 'ANU',
                                    numLineaLista);
                                dataAnu = {
                                    "cod_trabajador": codTrabajadorLista,
                                    "num_linea": numLineaLista,
    ...
    btnConfig.addEventListener("click", function() {
        ...
        for (var i = 0; i < filas.length; i++) {
            ...
            console.log(valorDorado, valorVerde);
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                if (respuesta['response'].length > 0) {
                    data = [];
                    var header = ['SOLICITUD', 'TRABAJADOR', 'NOMBRES Y APELLIDOS', 'ÁREA', 'SEDE',
                        'CARGO', 'FECHA INICIO VAC.', 'FECHA FIN VAC.', 'DÍAS VAC.',
                        'DÍA DE INCORPORACIÓN', 'ESTADO ACTUAL SOL.', 'SUBESTADO APROBACIÓN',
                        'SUBESTADO RECHAZO', 'SUBESTADO SOLICITUD', 'ESTADO FIRMA SOL.',
                        ' ESTADO DE PAGO', 'CANT. DÍAS EXCEDIDOS', 'REPROGRAMACIÓN',
                        'FECHA REGISTRO SOL.', 'CÓDIGO TRABAJADOR REGISTRÓ',
                        'FECHA APROBACIÓN SOL.', 'CÓDIGO TRABAJADOR DEL APROBADOR',
                        'FECHA RECHAZO SOL.', 'CÓDIGO TRABAJADOR DE RECHAZO'
                    ];
                    respuesta['response'].forEach(element => {
                        ...
                        var firmado = (element['flg_firmado'] == 'SI') ? 'FIRMADO' :
                            'NO FIRMADO';
                        var pagado = (element['flg_pagado'] == 'SI') ? 'PAGADO' :
                            'NO PAGADO';
                        var solicitudAnt = (element['num_linea_origen'] != 0) ? element[
                            'cod_trabajador'] + '-' + element['num_linea_origen'] : '';
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            respuesta['response'].forEach(function(word) {
                //console.log(word);
                $("#annoIniVE").append('<option value="' + word['codvar'] + '">' + word['desvar1'] +
                    '</option>');
                $("#annoFinVE").append('<option value="' + word['codvar'] + '">' + word['desvar1'] +
                    '</option>');
    ...
    function enviaRechazoVac(codTra, fchIni, fchFin, accionEnvio, numSolicitud) {
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                var actividad = '';
                if (accionEnvio == 'REC') {
                    actividad = 'La solicitud de vacaciones ha sido rechazada por el jefe. (Inicio: ' +
                        fchIni + ', fin: ' + fchFin + ')';
                } else if (accionEnvio == 'ANU') {
                    actividad = 'La solicitud de vacaciones ha sido rechazada por anulación. (Inicio: ' +
                        fchIni + ', fin: ' + fchFin + ')';
                }
    ...
    function enviaAprobacionVac(codTra, fchIni, fchFin, numSolicitud) {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                var fechaFormateada = diaFormateado + '/' + mesFormateado + '/' + anio;
                var fchBD = anio + '-' + mesFormateado + '-' + diaFormateado;
                var actividad = 'La solicitud de vacaciones ha sido aprobada por jefe. (Inicio: ' + fchIni +
                    ', fin: ' + fchFin + ')';
                        ...
                        if (data.error) {
                            ...
                            $.ajax({
                                ...
                                success: function(respuesta) {
                                        ...
                                        if (estado ==
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(
                                                    ...
                                                    actividad =
                                                        'La solicitud de vacaciones ha sido ingresada. (Inicio: ' +
                                                        fchInicio +
                                                        ', fin: ' +
                                                        fchFin +
                                                        ')';
                                                    asuntoJefe =
                                                        'Aceptar/rechazar una solicitud de vacaciones.';
                                            ...
                                            actividad =
                                                'La solicitud de vacaciones ha sido rechazada. (Inicio: ' +
                                                fchInicio + ', fin: ' + fchFin +
                                                ')';
                                            //envia correo a trabajador
                                            enviaCorreoMensaje(codTra,
                                                codTraSolic, dscSolicitante,
                                                codMensaje, '', asunto,
                                                actividad, numSolicitud);
                                        } else if (estado ==
                                            'APROBADO') { //Aprobado
                                            ...
                                            enviaCorreoMensaje(codTra,
                                                codTraSolic, dscSolicitante,
                                                codMensajeA, '', asuntoA,
                                                actividadA, numSolicitud);
                                            codMensaje = '4002';
                                            asunto =
                                                'La solicitud de vacaciones ha sido aprobada';
                                            actividad =
                                                'La solicitud de vacaciones ha sido aprobada. (Inicio: ' +
                                                fchInicio + ', fin: ' + fchFin +
                                                ')';
                                            //envia correo a trabajador
                                            enviaCorreoMensaje(codTra,
                                    ...
                                    enviaCorreoMensaje(codTraSolic, codTraSolic,
                                        dscSolicitante, '4005', '',
                                        'Has realizado la carga masiva de solicitud de vacaciones.',
                                        'Has realizado la carga masiva de solicitud de vacaciones.',
                                        numSolicitudCarga);
                                    $("#overlay_load").hide();
                                    Swal.fire({
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(respuesta) {
                                            console.log('lista solicitud',
                                                respuesta);
                                            respuesta['response'].forEach(
                                                element => {
                                                    var codTra = element[
                                                        'cod_trabajador'
                                                    ];
                                                    var fchLimite = element[
                                                        'fch_limite'];
                                                    var fchInicio = element[
                                                        'fch_inicio'];
                                                    var fchFin = element[
                                                        'fch_fin'];
                                                    var numSolicitud =
                                            ...
                                            numSolicitudCarga = 404;
                                            //envia correo a trabajador que cargo el archivo
                                            enviaCorreoMensaje(codTraSolic,
                                                codTraSolic, dscSolicitante,
                                                '4005', '',
                                                'Has realizado la carga masiva de solicitud de vacaciones.',
                                                'Has realizado la carga masiva de solicitud de vacaciones.',
