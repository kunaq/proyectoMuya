                                ...
                                <div class="col-md-8 offset-md-3">
                                    <div class="form-group">
                                        <select name="Trabajador" id="Trabajador"
                                            class="form-control selectForm js-example-diacritics"
                                            onchange="ObtenerTrabajador(this.value)">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="row" style="padding-bottom: 1rem;">
                                    ...
                                    <div class=" col-5 col-md-3">
                                        <div class="form-group">
                                            <input type="text" name="cod_grupo" id="cod_grupo" value=""
                                                style="text-align: center" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class=" col-7 col-md-4">
                                        <div class="form-group">
                                            <input type="text" name="dsc_grupo" id="dsc_grupo" value=""
                                                style="text-align: center" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="padding-bottom: 1rem;">
                                    ...
                                    <div class=" col-5 col-md-3">
                                        <div class="form-group">
                                            <input type="text" name="cod_comisionista" id="cod_comisionista"
                                                value="" style="text-align: center" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class=" col-7 col-md-4">
                                        <div class="form-group">
                                            <input type="text" name="dsc_comisionista" id="dsc_comisionista"
                                                value="" style="text-align: center" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="padding-bottom: 1rem;">
                                    ...
                                    <div class=" col-3 col-md-2">
                                        <div class="form-group">
                                            <input id="num_ultimo_dias" class="form-control " type="number"
                                                min="0" max="30" value="">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-12 col-md-5" style="margin-bottom: 1rem">
                                        <div class="form-group">
                                            <select name="codSupervisor" id="codSupervisor"
                                                class="form-control selectForm js-example-diacritics">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-2 offset-md-10" style="text-align: -webkit-center">
                                        <div class="form-group">
                                            <h5><button class="btn btn-success btnDorado" id=""
                                                    onclick="Guardar()">Guardar</button></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12 col-md-2" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado"
                                                id="btnDescVacaciones">Descargar</button></h5>
                                    </div>
                                </div>
                                ...
                                <div class="col-12" style="text-align: -webkit-center">
                                    <div class="form-group">
                                        <h5><button class="btn btn-success btnDorado" id="btnModalCarga"
                                                ...
                                                data-bs-target="#ModalCargaMasivaConfig">Cargar</button></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    window.onload = function() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                respuesta['response'].forEach(function(word) {
                    ...
                    //console.log(word);
                    $("#Trabajador").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
                });
            }, //success
            error(e) {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                respuesta['response'].forEach(function(word) {
                    ...
                    //console.log(word);
                    $("#Responsable").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
                });
            }, //success
            error(e) {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                respuesta['response'].forEach(function(word) {
                    //console.log(word);
                    $("#annoIniConfig").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
    ...
    function ObtenerTrabajador(codTra) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#codSupervisor').val(result["response"]["cod_supervisor_asistencia"]).trigger(
                    'change.select2');
    ...
    btnProcesar.addEventListener("click", function() {
        ...
        // var codTra = '@php echo(session('codTrabajador')) @endphp';
        var codTra = (document.getElementById("Trabajador").value == '') ? '%' : document.getElementById(
            "Trabajador").value;
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                if (respuesta['response'].length > 0) {
                    var header = ['CODIGO TRABAJADOR', 'NOMBRES Y APELLIDOS', 'SEDE', 'CARGO',
                        'AREA', 'FECHA INGRESO', 'VACACIONES GENERADAS',
                        'VACACIONES SOLICITADAS', 'SALDO', 'VACACIONES APROBADAS',
                        'ESTADO ADELANTO VACACIONES', 'GRUPO', 'TIPO COMISIONISTA',
                        'REQUIERE APROBACION', 'APROBADOR', 'CODIGO TRABAJADOR APROBADOR',
                        ' REQUIERE SUPERVISION', 'SUPERVISOR', 'CODIGO TRABAJADOR SUPERVISOR',
                        'REGLA'
                    ];
                    var filasArray = [];
