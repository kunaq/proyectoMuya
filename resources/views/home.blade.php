<x-layouts.app title="Home" meta-description="Home meta description">
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title titulo-home">
                                <span> ¡Hola </span>
                                <span class="primMayus"
                                    id="nombreTrabajador"><strong>{{ session('nombreBienvenida') }}</strong>!</span>
                                <br> <span> BienvenidO(a) a la plataforma de Grupo Muya</span>
                            </h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5><button class="btn btn-descarga-boleta" id="btnDscgBoleta">Descargar
                                            Boleta</button></h5>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-md-10 mt-4 offset-md-1 d-none d-md-block">
                    <div class="card">
                        <div class="card-body">
                            <div style="display: flex;justify-content: center;">
                                <strong class="card-title" style="font-size: 25px;">Tus últimos mensajes</strong>
                            </div>
                                    ...
                                    <table class="table table-striped ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" width="15%" style="text-align: center;">Limite
                                                </th>
                                                <th scope="col" width="20%" style="text-align: center;">
                                                    Solicitante</th>
                                                <th scope="col" width="40%" style="text-align: center;">Mensaje
                                                </th>
                ...
                <div class="col-sm-10 d-sm-block d-md-none">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 25px;">Tus últimos mensajes</h5>
                            <div class="row">
                                <div class="col-md-12 table-responsive" style="padding-left: 2rem;padding-right: 2rem;">
                                    <table class="table table-striped ">
    ...
    window.onload = function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                // document.getElementById("dsc_ultima_boleta").innerHTML = result["response"][
                //     "dsc_ultima_boleta"
                // ];

                var btnDescarga = document.getElementById('btnDscgBoleta');
                if (result["response"]["dsc_ultima_boleta"] == 'NULL' || result["response"][
                        "dsc_ultima_boleta"
                    ] == "") {
            ...
            success: function(respuesta) {
                ...
                respuesta['response'].forEach(function(element) {
                    ...
                    filaDataMovil += '<tr>' +
                        ...
                        '<b>Solicitante:</b>' + element['dsc_trabajador_solicitante'] +
                        '</br>' +
                        filaAccion + '</td>' +
                        '</tr>';
    ...
    btnSolicitar.addEventListener("click", function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                var completo = result['response']['dsc_base_64'] + result['response'][
                        'dsc_base_64_2'
                    ] + result['response']['dsc_base_64_3'] + result['response']['dsc_base_64_4'] +
                    result['response']['dsc_base_64_5'] + result['response']['dsc_base_64_6'] +
                    result['response']['dsc_base_64_7'] + result['response']['dsc_base_64_8'] +
                    result['response']['dsc_base_64_9'] + result['response']['dsc_base_64_10'];
